...
def parse_args() -> argparse.Namespace:
    ...
    attack_parser.add_argument(
        ...
        type=float, 
        default=0.05,
        help="Percentage of characters to replace (default: 0.05)"
    )
    attack_parser.add_argument(
        "--seed", 
        type=int, 
    ...
    attack_parser.add_argument(
        "--same-script", 
        action="store_true", 
        help="Only use homoglyphs from the same script"
    )
    attack_parser.add_argument(
        "--same-block", 
        action="store_true", 
        help="Only use homoglyphs from the same Unicode block"
    )
    attack_parser.add_argument(
        "--homoglyph-types", 
        type=str, 
