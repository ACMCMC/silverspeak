...
class HomoglyphReplacer:
    ...
    def get_homoglyph_for_char(
        ...
        This method selects an optimal homoglyph replacement for a character by comparing
        the Unicode properties of the potential homoglyphs with those of the original character.
        ...
        if context:
            # Score each possible homoglyph using our scoring function
            property_scores = []
