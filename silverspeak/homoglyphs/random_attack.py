...
def random_attack(
    ...
    Args:
        ...
        unicode_categories_to_replace (Optional[List[str]], optional): Unicode categories
    ...
    original_positions = {}  # Track original positions to handle multi-character replacements
